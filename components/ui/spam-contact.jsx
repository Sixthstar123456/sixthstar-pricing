...
import { SpamfilterContactusform } from "../../lib/api";
...
export default function ContactFormSpam() {
  ...
  const onSubmit = async (event) => {
    ...
    try {
      await SpamfilterContactusform(formData);
  ...
  return (
    <div id="spamcontact" className="py-12 px-4 sm:px-6 lg:px-8 perspective-1000">
              ...
              <form className="space-y-6" onSubmit={onSubmit}>
                ...
                <div>
                  ...
                  >
                    ...
                    <option className="text-black" value="Incomming Spamfilter">Incomming Spamfilter</option>
                    <option className="text-black" value="Outgoing Spamfilter">Outgoing Spamfilter</option>
