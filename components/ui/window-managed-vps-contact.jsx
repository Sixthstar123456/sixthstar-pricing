...
const ContactFormWindowManaged= () => {
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div>
                  ...
                  >
                    ...
                    <option value="other" className="text-black">Standard SSl</option>
                    <option value="other" className="text-black">Wildcard SSl</option>
                    <option value="general" className="text-black">Multi Domain SSl</option>
...
export default ContactFormWindowManaged;