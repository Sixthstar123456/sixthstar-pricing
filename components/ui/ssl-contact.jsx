...
import { SSlContactusform } from "../../lib/api";

const initState = { values: {}, isLoading: false };

export default function ContactFormSpam() {
  ...
  const onSubmit = async (event) => {
    ...
    try {
      await SSlContactusform(formData);
  ...
  return (
    <div id="ssl-contactus" className="py-12 px-4 sm:px-6 lg:px-8 perspective-1000">
              ...
              <form className="space-y-6" onSubmit={onSubmit}>
                ...
                <div>
                  ...
                  >
                    ...
                    <option className="text-black" value="Standard SSL">Standard SSL</option>
                    <option className="text-black" value="Wildcard SSL">Wildcard SSL</option>
                    <option className="text-black" value="Multi Domain SSL">Multi Domain SSL</option>
                  </select>
                </div>
