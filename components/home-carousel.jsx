...
const testimonials = [
  {
    id: 1,
    bgImage: "https://res.cloudinary.com/dwyn5jgh3/image/upload/v1741692997/Untitled_design_14_fja2q7.jpg",
  },
  {
    id: 2,
    bgImage: "https://res.cloudinary.com/dwyn5jgh3/image/upload/v1741692996/Untitled_design_16_nfoodu.jpg",
  },
  {
    id: 3,
    bgImage: "https://res.cloudinary.com/dwyn5jgh3/image/upload/v1741692987/Untitled_design_15_gzxqcr.jpg",
  },
  {
    id: 4,
    bgImage: "https://res.cloudinary.com/dwyn5jgh3/image/upload/v1741692987/Untitled_design_15_gzxqcr.jpg",
      ...
      <div className="overflow-hidden relative">
        ...
        >
          {testimonials.map(testimonial => (
            ...
            >
              <Card
                className="h-[300px] rounded-xl  overflow-hidden bg-center bg-cover relative"
                style={{
              ...
              >
                ...
                {/* <div className="relative z-10 p-6 text-white">
                  <p className="text-lg font-semibold">Testimonial {testimonial.id}</p>
                </div> */}
              </Card>
            </div>
          ))}
